...
function Spinner() {
  return (
    <svg className="animate-spin h-5 w-5 mr-2 text-blue-300 inline-block" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  outline:
    "bg-gray-900 hover:bg-blue-800 text-blue-200 border border-blue-700",
  ghost:
