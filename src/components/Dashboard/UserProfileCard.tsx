      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-secondary-700 p-4 rounded">
          ...
          <div className="font-semibold text-primary-300">
            {user.roles_and_permissions.primary_role}
          </div>
        </div>
        ...
        <div className="bg-secondary-700 p-4 rounded">
          ...
          <div className="font-semibold text-tertiary-400">
        ...
        {user.accessible_organizations.length > 0 && (
          <div className="bg-secondary-700 p-4 rounded">
            ...
            <div className="font-semibold text-white">
              {user.accessible_organizations.length} org(s)
            </div>
          </div>
        )}
      </div>
        ...
        <div className="mt-4">
          ...
          <div className="space-y-1">
            {user.accessible_organizations.map((org, index) => (
              <div
                key={index}
                className="flex justify-between items-center text-sm bg-secondary-700 p-2 rounded"
              >
