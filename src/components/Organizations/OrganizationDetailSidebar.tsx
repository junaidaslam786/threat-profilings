...
const OrganizationDetailSidebar: React.FC<OrganizationDetailSidebarProps> = ({ 
  ...
  return (
    <Sidebar isOpen={isOpen} onClose={onClose} title={organization.organization_name}>
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-primary-500/10 to-primary-600/10 rounded-xl p-6 border border-primary-500/20">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-white">{organization.organization_name}</h3>
              <p className="text-primary-400 text-sm">{organization.client_name}</p>
              {organization.sector && (
        ...
        <div className="bg-secondary-800/50 rounded-xl p-6 border border-secondary-700/30">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              onClick={() => handleNavigate(`/orgs/${organization.client_name}/edit`)}
            ...
            <button 
              onClick={() => handleNavigate(`/orgs/${organization.client_name}/settings`)}
        ...
        <div className="bg-secondary-800/50 rounded-xl p-6 border border-secondary-700/30">
          ...
          <div className="space-y-3">
            <button 
              onClick={() => handleNavigate(`/orgs/${organization.client_name}/security-assessment`)}
              className="w-full p-4 bg-gradient-to-r from-red-600/20 to-red-700/20 rounded-lg hover:from-red-500/30 hover:to-red-600/30 transition-all duration-200 border border-red-500/30 hover:border-red-400/50 group"
            >
            ...
            <button 
              onClick={() => handleNavigate(`/orgs/${organization.client_name}/vulnerability-scan`)}
              className="w-full p-4 bg-gradient-to-r from-orange-600/20 to-orange-700/20 rounded-lg hover:from-orange-500/30 hover:to-orange-600/30 transition-all duration-200 border border-orange-500/30 hover:border-orange-400/50 group"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white font-medium">Vulnerability Scan</span>
                </div>
                <svg className="w-4 h-4 text-secondary-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
        ...
        <div className="bg-secondary-800/50 rounded-xl p-6 border border-secondary-700/30">
          ...
          <div className="space-y-3">
            <button 
              onClick={() => handleNavigate(`/orgs/${organization.client_name}/threat-reports`)}
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white font-medium">Threat Reports</span>
                </div>
                <svg className="w-4 h-4 text-secondary-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
            ...
            <button 
              onClick={() => handleNavigate(`/orgs/${organization.client_name}/analytics`)}
            ...
            <button 
              onClick={() => handleNavigate(`/orgs/${organization.client_name}/compliance`)}
              className="w-full p-4 bg-gradient-to-r from-teal-600/20 to-teal-700/20 rounded-lg hover:from-teal-500/30 hover:to-teal-600/30 transition-all duration-200 border border-teal-500/30 hover:border-teal-400/50 group"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white font-medium">Compliance Reports</span>
                </div>
                <svg className="w-4 h-4 text-secondary-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
        ...
        {/* Contact Information */}
        {(organization.contact_email || organization.phone || organization.website_url) && (
          <div className="bg-secondary-800/50 rounded-xl p-6 border border-secondary-700/30">
            <div className="flex items-center space-x-3 mb-4">
            ...
            <div className="space-y-4">
              {organization.created_at && (
                <div className="flex items-center space-x-4 p-3 bg-secondary-700/30 rounded-lg">
                  ...
                  <div>
                    <div className="text-sm font-medium text-white">Organization Created</div>
                    <div className="text-xs text-secondary-400">{new Date(organization.created_at).toLocaleDateString()}</div>
                  </div>
                </div>
              )}
              {organization.updated_at && (
                <div className="flex items-center space-x-4 p-3 bg-secondary-700/30 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-secondary-400">{new Date(organization.updated_at).toLocaleDateString()}</div>
                  </div>
                </div>
              )}
            </div>
