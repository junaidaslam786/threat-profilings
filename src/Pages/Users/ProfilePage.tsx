        ...
        {profileData ? (
          <div className="space-y-8">
            ...
            >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="text-white font-medium">
                      {profileData.user_info?.name || "Not provided"}
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-secondary-400 mb-1">
                    ...
                    <div className="text-white font-medium">
                      {profileData.user_info?.email || "Not provided"}
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-secondary-400 mb-1">
                    ...
                    <div className="text-white font-medium">
                      {new Date(
                        profileData.user_info.created_at
                      ).toLocaleString()}
                    </div>
                  </div>
                </div>
              ...
              {/* Account Statistics - Only shown to admins and LE admins */}
              {(isAdmin || isLEAdmin) && (
                <div className="bg-gradient-to-br from-secondary-800 to-secondary-900 rounded-xl p-6 border border-secondary-700/50">
                  <h3 className="text-xl font-bold text-white mb-6">
                    Account Statistics
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-secondary-700/30 rounded-lg">
                      ...
                      <span className="text-lg font-medium text-secondary-200">
                        Jan 2024
                      </span>
                    </div>
                  </div>
            ...
            <div className="bg-gradient-to-br from-secondary-800 to-secondary-900 rounded-xl p-6 border border-secondary-700/50">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center space-x-4 p-3 bg-secondary-700/30 rounded-lg"
                  >
