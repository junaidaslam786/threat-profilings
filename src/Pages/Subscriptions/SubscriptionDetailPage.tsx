    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-xl mx-auto bg-gray-800 rounded-xl shadow-lg border border-secondary-700 p-8">
        ...
        {!editing ? (
          <>
            <div className="mb-3">
              <span className="text-secondary-400 font-semibold">Tier:</span>{" "}
              {sub.subscription_level}
            </div>
            <div className="mb-3">
              <span className="text-secondary-400 font-semibold">Run quota:</span>{" "}
              {sub.run_quota}
            </div>
            <div className="mb-3">
              <span className="text-secondary-400 font-semibold">Run number:</span>{" "}
              {sub.run_number ?? "-"}
            </div>
            <div className="mb-3">
              <span className="text-secondary-400 font-semibold">Progress:</span>{" "}
              {sub.progress}%
            </div>
            <div className="mb-3">
              <span className="text-secondary-400 font-semibold">Max Edits:</span>{" "}
              {sub.max_edits ?? "-"}
            </div>
            <div className="mb-3">
              <span className="text-secondary-400 font-semibold">Max Apps:</span>{" "}
              {sub.max_apps ?? "-"}
            </div>
            <div className="mb-3">
              <span className="text-secondary-400 font-semibold">Features:</span>{" "}
              {(sub.features_access || []).join(", ")}
            </div>
            <div className="mb-3">
              <span className="text-secondary-400 font-semibold">Payment:</span>{" "}
              {sub.payment_status ?? "-"}
            </div>
          ...
          <form className="space-y-2" onSubmit={handleSave}>
            <label className="block text-secondary-300 font-semibold">Tier</label>
            <select
              name="tier"
            ...
            <label className="block text-secondary-300 font-semibold">
              Run Number
            </label>
            <input
              type="number"
